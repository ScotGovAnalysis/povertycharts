...
# PURPOSE OF SCRIPT: Make poverty charts 4 
# CONTACTS:          contacts
# SOURCES:           sources
# NOTES:             notes
###############################################################################

# Charts4 - child poverty update (charts cp1, cp2, cp3, cp4)
...
ggplot(data, aes(x = year, 
  ...
  scale_x_discrete(drop = FALSE,
                   ...
                   labels = c("1994/95", "2017/18", "2023/24", "2030/31"),
                   expand = c(0.1, 0.1)) +
...
ggsave(file, width = 13, height = 6.4, units = "cm", dpi = 300)


## Chart cp2 - Abspov ch ----

data <- cp2data
file <- "charts/cp2_abspovch.png"
...
ggplot(data, aes(x = year, 
  ...
  scale_x_discrete(drop = FALSE,
                   ...
                   labels = c("1994/95","2010/11", "2017/18", "2023/24", "2030/31"),
                   expand = c(0.1, 0.1)) +
